...
let screenTwo = window.matchMedia("(max-width: 850px)");

if (screenTwo.matches) {
  console.log("AHAHAHAHAHAAAA");
  document.querySelector("#main").style.marginLeft = "24px";
  state = "closed";
  localStorage.setItem("sidebar_state", "closed");
}
